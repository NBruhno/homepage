...
verifyVariable('IGDB_WEBHOOK_SECRET', true)
verifyVariable('NEXT_PUBLIC_SENTRY_DSN', true)
verifyVariable('POSTGRES_PRISMA_URL', true)
verifyVariable('POSTGRES_URL_NON_POOLING', true)
verifyVariable('REDIS_URL', true)
