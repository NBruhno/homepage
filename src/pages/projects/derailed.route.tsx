		...
		<Page>
			<PageContent maxWidth={900}>
				...
				<p>
					...
					<a href='https://firebasestorage.googleapis.com/v0/b/bruhno-afb29.appspot.com/o/projects%2FMTA_16542_Report.pdf?alt=media&token=f20643a8-8888-4c16-a29d-62dd3ee826ba'>
						read or look through our report
					</a>
					. We also made a video showcasing the game and the project as a whole which you can watch{' '}
					<a href='https://youtu.be/SBas-H8hG_A'>here if you are interested</a>.
				</p>
			</PageContent>
		</Page>
	)
