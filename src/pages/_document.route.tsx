		...
		return (
			<Html lang='en' dir='ltr'>
				<Head>
					...
					<meta
						name='description'
						content="This is Nicolai Bruhn Lauritsen or more commonly known as Bruhno's personal website which functions as a portfolio and a playground."
					/>
				...
				<body>
					...
					<noscript>
						...
						<div className='noScript'>
							You&apos;ve disabled JavaScript, so a lot of things <b>will not work</b>. This website is not designed to
							function without JavaScript, <b>please respect that</b>.
						</div>
					</noscript>
					<NextScript />
				</body>
