	...
	return (
		<Page>
			<PageContent maxWidth={900}>
				...
				<p>
					Usage Data may include information such as Your Device&apos;s, browser type, browser version, the pages of our
					Service that You visit, the time and date of Your visit and other diagnostic data.
				</p>
				<p>
					When You access the Service by or through a mobile device, We may collect certain information automatically,
					including, but not limited to, the type of mobile device You use, Your mobile device unique ID, Your mobile
					operating system, the type of mobile Internet browser You use and other diagnostic data.
				</p>
				<p>
				...
				<p>
					...
					<NextLink href='/cookies'>Cookies Policy</NextLink> or the Cookies section of our Privacy Policy.
				</p>
